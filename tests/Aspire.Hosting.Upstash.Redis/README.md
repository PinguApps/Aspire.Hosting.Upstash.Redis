...
- `10.1`: covered in `Features/ApiShape/TypeScriptAppHostFixture.feature` by validating the checked-in TypeScript AppHost fixture consumes the intended generated module surface, calls `publishToUpstash`, consumes supplementary outputs, preserves normal Redis references, restores the generated SDK, type-checks the generated surface, starts locally with Redis readiness handling, lists publish steps, and keeps generated modules out of source control.
