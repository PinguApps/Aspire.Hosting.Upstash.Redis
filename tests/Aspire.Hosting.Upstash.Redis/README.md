...
- `10.1`: partially covered in `Features/ApiShape/TypeScriptAppHostFixture.feature` by validating the checked-in TypeScript AppHost fixture consumes the intended generated module surface, calls `publishToUpstash`, consumes supplementary outputs, preserves normal Redis references, exposes restore/run/publish/type-check commands, and keeps generated modules out of source control.
