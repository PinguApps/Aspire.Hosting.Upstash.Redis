...
- `Fixtures/TypeScriptAppHost` is the checked-in TypeScript AppHost validation fixture. Generated `.modules/` content is regenerated by Aspire CLI flows and must not be committed.
